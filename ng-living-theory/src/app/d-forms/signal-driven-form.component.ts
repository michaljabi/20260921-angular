      ...
      <fieldset class="field ">
        <label>
          ...
          <input
            [class]="[
              'input',
              sampleForm.name().invalid() && sampleForm.name().touched() ? 'is-danger' : '',
            ]"
            [formField]="sampleForm.name"
          />
        </label>
      ...
      <fieldset class="field">
        <label>
          ...
          <textarea
            [class]="[
              'textarea',
              sampleForm.post().invalid() && sampleForm.post().touched() ? 'is-danger' : '',
            ]"
            [formField]="sampleForm.post"
          ></textarea>
        </label>
